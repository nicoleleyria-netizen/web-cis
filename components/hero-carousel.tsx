...
const slides = [
  {
    ...
    image: "/images/medicina-laboral/banner-medicina-laboral.jpg",
  },
  {
    id: 2,
    ...
    image: "/images/servicios-medicos-generales/banner-servicios-medicos-generales.jpg",
  },
  {
    id: 3,
    ...
    image: "/images/medicina-del-deporte/banner-medicina-del-deporte.jpg",
  },
]
...
export function HeroCarousel() {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 md:left-8 top-1/2 z-20 -translate-y-1/2 rounded-full bg-white/20 backdrop-blur-sm p-3 md:p-4 text-white transition-all hover:bg-white/30 border border-white/30 hidden md:flex items-center justify-center"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 md:right-8 top-1/2 z-20 -translate-y-1/2 rounded-full bg-white/20 backdrop-blur-sm p-3 md:p-4 text-white transition-all hover:bg-white/30 border border-white/30 hidden md:flex items-center justify-center"
