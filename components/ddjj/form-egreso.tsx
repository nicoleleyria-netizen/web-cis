...
export function FormEgreso() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      secciones: [
        ...
        {
          titulo: "2. Datos de la Empresa",
          campos: [
            { label: "Empresa", valor: g("empresa") },
            { label: "Puesto ocupado", valor: g("puestoOcupado") },
            { label: "Fecha de ingreso", valor: g("fechaIngreso") },
            { label: "Fecha de egreso (o prevista)", valor: g("fechaEgreso") },
          ],
        },
        {
        ...
        {
          titulo: "4. Historia Laboral en la Empresa",
          campos: [
            { label: "¿Sufrió accidentes laborales durante la relación laboral?", valor: yn("accidenteLab") },
            ...(yn("accidenteLab") === "si"
              ? [{ label: "Descripción (cuál / cuándo)", valor: g("detAccidente") }]
              : []),
            { label: "¿Fue diagnosticado/a con enfermedades profesionales?", valor: yn("enfermedadProf") },
            ...(yn("enfermedadProf") === "si" ? [{ label: "Descripción", valor: g("detEnfermedad") }] : []),
            { label: "¿Quedaron secuelas de accidente o enfermedad laboral?", valor: yn("secuelas") },
            ...(yn("secuelas") === "si" ? [{ label: "Descripción de las secuelas", valor: g("detSecuelas") }] : []),
            { label: "¿Recibió indemnizaciones por accidente o enfermedad?", valor: yn("indemnizacion") },
        ...
        {
          titulo: "6. Antecedentes Familiares",
          campos: [
            {
        ...
        {
          titulo: "7. Antecedentes Médicos Personales",
          campos: [
            {
        ...
        {
          titulo: "8. Cirugías y Hospitalizaciones",
          campos: [
        ...
        {
          titulo: "10. Estado Actual de Salud",
          campos: [
            { label: "¿Actualmente toma alguna medicación?", valor: yn("medicActual") },
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <SectionCard num={2} title="Datos de la Empresa">
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Empresa" required>
            <Input name="empresa" required />
          </Field>
          <Field label="Puesto ocupado" required>
            <Input name="puestoOcupado" required />
          </Field>
          <Field label="Fecha de ingreso">
            <Input name="fechaIngreso" type="date" />
          </Field>
          <Field label="Fecha de egreso (o prevista)">
      ...
      <SectionCard num={4} title="Historia Laboral en la Empresa">
        <div className="space-y-5">
          <YesNoToggle
            label="¿Sufrió accidentes laborales durante la relación laboral?"
          ...
          <YesNoToggle
            label="¿Fue diagnosticado/a con enfermedades profesionales?"
          ...
          <YesNoToggle
            label="¿Quedaron secuelas de accidente o enfermedad laboral?"
            value={yn("secuelas")}
            onChange={(v) => setYN("secuelas", v)}
          >
            <Field label="Descripción de las secuelas">
              <Textarea name="detSecuelas" rows={2} />
            </Field>
          </YesNoToggle>
          <YesNoToggle
            label="¿Recibió indemnizaciones por accidente o enfermedad?"
      ...
      <SectionCard num={6} title="Antecedentes Familiares">
      ...
      <SectionCard num={7} title="Antecedentes Médicos Personales">
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
      ...
      <SectionCard num={8} title="Cirugías y Hospitalizaciones">
        <div className="space-y-5">
      ...
      <SectionCard num={9} title="Alergias">
        <YesNoToggle
      ...
      <SectionCard num={10} title="Estado Actual de Salud">
        <div className="space-y-5">
          <YesNoToggle
      ...
      <SectionCard num={11} title="Declaración Final">
        <div className="space-y-4">
