...
const cards: Card[] = [
  ...
  },
  {
    ...
    details: [
      ...
      { label: "Audiometria, logoaudiometria, sisigrama, valoracion del lenguaje" },
      { label: "Ecocardiografia" },
      { label: "Laringoscopia, fibrolaringoscopia, rinoscopia" },
      { label: "Agudeza visual, fondo de ojos" },
      { label: "PAP, colposcopia" },
    ],
  },
  {
    icon: HeartPulse,
  ...
  },
  {
    ...
    details: [
      ...
      { label: "Aptitud ANMAC" },
      { label: "Aptitud para uso de natatorio y piletas" },
      { label: "Aptitud para gimnasios" },
      { label: "Certificados escolares" },
      { label: "Certificaciones para cruceros" },
      { label: "Certificaciones para carnet de timonel y embarcaciones" },
      { label: "Aptitud para ingresos a las FFAA" },
    ],
  },
  {
    icon: Video,
